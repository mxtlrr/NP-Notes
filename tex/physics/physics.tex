...
\begin{document}
  ...
  \begin{multicols*}{2}
    ...
    Isotope notation is a form of notating isotopes. It consists
    ...
    $A$ is the mass number of said isotope (which is found by $Z+N$, where
    $N$ is the neutrons), $Z$ is the number of protons. Finally, $X$ is the
    chemical formula.
    ...
    \begin{tabular}{|c|c|c|}
      ...
      \hline
      Proton  & $1.007$  & $\ce{^1_0{p}}$ \\
      Neutron & $1.003$  & $\ce{^1_0{n}}$ \\
      \hline
    \end{tabular}

    \section{Modes of Decay}
    ...
    positron, transforming it into an \textbf{isobar}\footnote{Isobars are atoms of different elements that have the same number of
    nucleons. They differ in atomic number but have the same $A$ value.} of the original nuclide.\\
