...
\begin{document}
  ...
  \begin{multicols*}{2}
    ...
    \begin{equation*}
      \begin{split}
        \lambda = \frac{0.693}{83412720} = 8.308 \cdot 10^{-9} \\
        N = \frac{0.56}{252} \times \left(6.022 \times 10^{23}\right) \\
          = 0.002 \times \left(6.022 \times 10^{23}\right) \\
          = 1.338\times 10^{21}\\
        \\
        R = \lambda{N} = (8.308 \times 10^{-9}) \times (1.338 \times 10^{21}) \\
        = \boxed{1.11161 \times 10^{13}}
      \end{split}
    \end{equation*}
    ...
    \begin{equation*}
      \begin{split}
        R_C = \frac{1.111 \times 10^{13}}{3.7\times{10^{10}}} \\
        = \boxed{300.2 \text{ Ci}}
      \end{split}
    \end{equation*}
    \section{Isomers}
